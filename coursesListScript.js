...
function buildCourseButton(name, subject) {
	...
	//namePar.style.textAlign="left";
	//namePar.style.display="inline";
	//namePar.className = "leftAlign inline";
	
	var subjectPar = document.createElement("strong");
	//subjectPar.style.float="right";
	subjectPar.className="rightAlign";
	//subjectPar.className = "rightAlign inline"; 
